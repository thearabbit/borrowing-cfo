/************ Form *************/
Template.saving_depositReport.onCreated(function () {
    createNewAlertify('exchange');
});

Template.saving_depositReport.onRendered(function () {
    var name = $('[name="date"]');
    DateTimePicker.dateRange(name);
});

Template.saving_depositReport.events({
...
/************ Generate *************/
Template.saving_depositReportGen.helpers({
    data: function () {
        var query=Router.current().params.query;
        var params = "getDepositReport";
        Fetcher.setDefault(params, false);
        Fetcher.retrieve(params, 'getDepositReport', query);
